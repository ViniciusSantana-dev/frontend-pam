    ...
    connectedCallback() {
        ...
        this.innerHTML = `
            ...
            <ion-content class="ion-padding">
                ...
                <ion-list>
                    <ion-item>
                        <ion-input type="text" name="dsc_produto" label="Descriçaõ do Produto" label-placement="floating" required>
                        </ion-input>
                    </ion-item>
                        <ion-input type="number" step="0.01" name="valor_unit" label="Valor Unitario" label-placement="floating" required>
                        </ion-input>
                    </ion-item>
                    <ion-item>
